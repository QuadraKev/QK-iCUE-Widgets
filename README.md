...
| [Launch Countdown](widgets/QKLaunchCountdown) | Live T-minus countdown to the next rocket launch with status badge and upcoming timeline |
...
| [Weather](widgets/QKWeather) | Current conditions and forecast with dynamic UV index coloring |

## Installation

### Using iCUE's import (recommended)

1. Download a `.icuewidget` file from [Releases](https://github.com/QuadraKev/QK-iCUE-Widgets/releases)
