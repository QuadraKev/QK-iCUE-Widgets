...
- Fonts: **Jost is the sole typeface for all QK widgets.** Do not use OpenSans, Segoe UI, or any other font. Jost (variable, weights 100-900) is embedded as base64 woff2 in each HTML file (~35KB). Base64 data: `docs/jost-woff2-base64.txt`. Weight hierarchy: 700 for headings/numbers, 600 for body/labels, 400 for secondary text. See `docs/widget-design-rules.md` for the full visual style guide.
